...
@section('content')
        ...
        <div class="container-fluid user-profile-tab">
            <div class="profile-tab" id="profile_section">
                ...
                <div class="border rounded-2 d-flex align-items-center justify-content-between p-3 mt-3"
                    data-bs-toggle="modal" data-bs-target="#userpassword">
                    <div class="d-flex gap-2 align-items-center">
                        <svg class="svg-bg-color" xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                            viewBox="0 0 24 24">
                ...
                <div class="border rounded-2 d-flex align-items-center justify-content-between p-3 mt-3"
                    ...
                    <div class="d-flex gap-2 align-items-center">
                        <svg class="svg-bg-color" width="25" height="25" viewBox="0 0 18 18" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M9 0C4.0374 0 0 4.0374 0 9V12.7287C0 13.6503 0.8073 14.4 1.8 14.4H2.7C2.93869 14.4 3.16761 14.3052 3.3364 14.1364C3.50518 13.9676 3.6 13.7387 3.6 13.5V8.8713C3.6 8.63261 3.50518 8.40369 3.3364 8.2349C3.16761 8.06612 2.93869 7.9713 2.7 7.9713H1.8828C2.3832 4.4883 5.3802 1.8 9 1.8C12.6198 1.8 15.6168 4.4883 16.1172 7.9713H15.3C15.0613 7.9713 14.8324 8.06612 14.6636 8.2349C14.4948 8.40369 14.4 8.63261 14.4 8.8713V14.4C14.4 15.3927 13.5927 16.2 12.6 16.2H10.8V15.3H7.2V18H12.6C14.5854 18 16.2 16.3854 16.2 14.4C17.1927 14.4 18 13.6503 18 12.7287V9C18 4.0374 13.9626 0 9 0Z"
                                fill="#515C6F" />
                        </svg>
                        <div>
    ...
    <!-- ================================USER-PASSWORD-POPUP========================== -->
    <div class="modal fade bottom-to-top" id="userpassword" tabindex="-1" aria-labelledby="userpasswordLabel"
        aria-hidden="true">
