                        ...
                        <div class="d-flex align-items-center justify-content-between ">
                            ...
                            <div class="d-flex flex-column">
                                <div class="d-flex align-items-center justify-content-end">
                                    ...
                                    <button type="button" onclick="sharePucData('${value.vehicle_image}', '${value.registration_number}')"  class="${value.share_view_flag == '1' ? 'modal-btn-completed' : 'modal-btn-neutral'} py-1 px-2 ms-1 updateViewFlag_btn" data-id="${value.id}" data-flag-type="3">
